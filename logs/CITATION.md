...
performed using *fMRIPrep* 25.1.3
...
Co-registration was configured with nine degrees of freedomto account for distortions remaining in the BOLD reference.
...
Frames that exceeded a threshold of 0.3 mm FD or
1.2 standardized DVARS were annotated as motion outliers.
